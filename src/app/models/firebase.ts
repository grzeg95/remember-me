...
export const AnalyticsInjectionToken = new InjectionToken<Analytics>('Analysis');
export const RemoteConfigInjectionToken = new InjectionToken<RemoteConfig>('Analysis');
